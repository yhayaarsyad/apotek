    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="file:///C|/Users/yhayaarsyad/AppData/Roaming/Adobe/Dreamweaver CC 2019/en_US/Configuration/Temp/Assets/eam93BC.tmp/eCommerceAssets/images/200x200.png"></div>
          <p class="price">$50</p>
